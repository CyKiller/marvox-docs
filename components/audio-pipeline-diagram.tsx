...
import { Volume2, Zap, Dna, Settings2, Lock, BarChart3, Database, Gauge, RefreshCw } from "lucide-react"
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="rounded-lg border border-slate-800 bg-slate-950 p-6">
        ...
        <div className="space-y-4 text-sm text-slate-400">
          <div>
            <h3 className="flex items-center gap-2 font-semibold text-slate-300 mb-1"><Dna className="w-4 h-4 text-sky-400 shrink-0" /> Voice DNA Concept</h3>
            <p>
          ...
          <div>
            <h3 className="flex items-center gap-2 font-semibold text-slate-300 mb-1"><Settings2 className="w-4 h-4 text-sky-400 shrink-0" /> Voice Configuration Space</h3>
            <p>
          ...
          <div>
            <h3 className="flex items-center gap-2 font-semibold text-slate-300 mb-1"><Lock className="w-4 h-4 text-sky-400 shrink-0" /> Voice Vault Protection</h3>
            <p>
          ...
          <div>
            <h3 className="flex items-center gap-2 font-semibold text-slate-300 mb-1"><BarChart3 className="w-4 h-4 text-sky-400 shrink-0" /> Quality Scoring</h3>
            <p>
      ...
      <div className="rounded-lg border border-slate-800 bg-slate-950 p-6">
        ...
        <div className="space-y-4 text-sm text-slate-400">
          <div>
            <h3 className="flex items-center gap-2 font-semibold text-slate-300 mb-1"><Zap className="w-4 h-4 text-sky-400 shrink-0" /> Parallelization Guards</h3>
            <p>
          ...
          <div>
            <h3 className="flex items-center gap-2 font-semibold text-slate-300 mb-1"><RefreshCw className="w-4 h-4 text-sky-400 shrink-0" /> Error Recovery</h3>
            <p>
